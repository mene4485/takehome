...
class ChatRequest(BaseModel):
    ...
    message: str
    conversation_id: str
    container_id: Optional[str] = None  # Optional container_id for PTC state reuse
...
async def chat_stream(request: ChatRequest, db: Session = Depends(get_db)):
    ...
    Args:
        request: ChatRequest with message, conversation_id, and optional container_id
        db: Database session injected by FastAPI
    ...
    final_response = {"content": "", "tool_calls_count": 0, "container_id": None}
        ...
        try:
            ...
            async for event in chat_with_claude_streaming(
                ...
                if event["type"] == "response":
                    ...
                    final_response["container_id"] = event.get("container_id")
                ...
                if final_response["content"]:
                    create_message(
                        ...
                        metadata={
                            ...
                            "container_id": final_response["container_id"]
                        }
                    )
